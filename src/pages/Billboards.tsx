...
import { MapPin, Filter, Plus, Search, Edit } from 'lucide-react';
...
export default function Billboards() {
  ...
  const saveEdit = async () => {
    ...
    const { Billboard_Name, City, Municipality, District, Nearest_Landmark, Size, Level, Image_URL, image_name, is_partnership, partner_companies, capital, capital_remaining } = editForm as any;
